...
<tr>
    ...
    <td class="text-center align-middle">
        <div class="btn-group align-top">
            <a href="{{ route('admin.roles.edit', ['role'=>$role]) }}" class="btn btn-sm modal-effect btn-primary badge" data-bs-effect="effect-fall" data-bs-toggle="modal" data-bs-target="#modaldemo8" type="button">Редактировать</a>
