...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control" value="{{ $panel->title }}" placeholder="Введите имя панели">
        </div>
        <div class="form-group">
            <label class="ml-3">Alias:</label>
            <input name="alias" id="alias" class="form-control" oninput=" $('#alias').css('box-shadow', 'none');" type="text" value="{{ $panel->alias }}" placeholder="Введите alias">
        </div>
    </div>
    <div class="col-lg-6">
        <div class="form-group">
