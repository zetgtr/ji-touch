...
.button {
  ...
  &:hover {
    ...
    // box-shadow: 0 0px 40px 5px var(--c-primary), 0 0px 40px var(--c-primary), inset 0 0 0px 0px var(--c-primary);
...
.slider_inner-btn {
  ...
  &:hover {
    & {
      ...
      box-shadow: 0 0px 40px 5px var(--c-primary), 0 0px 40px var(--c-primary),
        inset 0 0 0px 0px var(--c-primary);
    }
    i {
      color: var(--c-primary);
    }
